...
class PolicyGradientActorCritic(object):
  ...
  def create_variables(self):
    ...
    actor_network_variables  = self.actor_network.trainable_weights
    critic_network_variables = self.critic_network.trainable_weights


    print actor_network_variables
